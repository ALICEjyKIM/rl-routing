...
from td3_train import Actor, max_steps
...
def parse_args():
    ...
    parser.add_argument("--model", default="TD3_basic_best.pth")
    parser.add_argument("--episodes", type=int, default=5)
    parser.add_argument("--video-folder", default="TD3_videos")
