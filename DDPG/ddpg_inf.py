...
from ddpg_train import Actor, max_steps
...
def render_inference(
    model_path="DDPG_basic_best.pth",
    episodes=5,
    video_folder="DDPG_videos",
    human=False,
    seed=None,
):
...
def parse_args():
    ...
    parser.add_argument("--model", default="DDPG_basic_best.pth")
    parser.add_argument("--episodes", type=int, default=5)
    parser.add_argument("--video-folder", default="DDPG_videos")
